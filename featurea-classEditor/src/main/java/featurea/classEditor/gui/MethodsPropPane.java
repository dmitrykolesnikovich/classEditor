 ...
 *-----------------------------------------------------------------------------------------
 * 1.04   25th Apr 2004   Tanmay   Made search a common feature across tabs.
 */

package featurea.classEditor.gui;

import featurea.classEditor.classfile.ClassFile;
import featurea.classEditor.classfile.MethodInfo;
...
import featurea.classEditor.guihelper.MethodTableModel;
...
public class MethodsPropPane extends javax.swing.JPanel {
    ...
    public void search(String sSrchStr, boolean bWrapSearch) {
        ...
        } else if (bWrapSearch && (0 != tblMethodNames.getSelectedRow())) { // wrap search
            iPrevMethodNew = tblModel.nextIndex(0, sSrchStr);
            if (iPrevMethodNew >= 0) {
                iPrevMethod = iPrevMethodNew;
                tblMethodNames.changeSelection(iPrevMethod, 1, false, false);
            }
